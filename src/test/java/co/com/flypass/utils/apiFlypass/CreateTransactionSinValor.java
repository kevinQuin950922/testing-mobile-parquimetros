...
public class CreateTransactionSinValor {
    public void createTransactionFromASFSinValor(String plate, String minutosAnticipado, String valor){
        ...
        while (intentos && intentosInt!=0){
            ...
            if (codigoEstado.equals("200")){
                ...
                String fechaEnd = null;
                String fechaStard =  LocalDateTime.now().plusMinutes(300).format(DateTimeFormatter.ISO_DATE_TIME);
                cuerpo="{\"amount\":"+0+",\"endDate\":\""+fechaEnd+"\",\"accountingDate\":\""+fechaStard+
                        "\",\"ingresoId\":"+ingresoId+",\"minutes\":"+0+",\"plate\":\""+plate+"\",\"readingType\": \"1\",\"taxesAmount\": 0.0," +
                        "\"transactionId\":\""+transactionId+"\",\"tiquete\":"+tiquete+",\"stationId\": \"100101\","+"\"details\":"+"[{\"amount\":"+
                        0+",\"description\": \"Description detail 286_ALS124_ov6NCNEwq55\",\"movementDate\":\""+
