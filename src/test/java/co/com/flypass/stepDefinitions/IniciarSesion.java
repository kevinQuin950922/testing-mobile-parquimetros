...
public class IniciarSesion {
    ...
    public void seIngresaBienElUsuarioYMalLaContrasena() {
        theActorCalled("Kevin").attemptsTo(co.com.flypass.task.IniciarSesion.iniciarSesionConContrasenaIncorrecta());
    }
    ...
    public void seIngresaBienElUsuarioYContrasena() {
        theActorCalled("Kevin").attemptsTo(co.com.flypass.task.IniciarSesion.iniciarSesionConContrasenacCorrecta());
    }

    @And("^Se ingresa token OTP$")
    public void SeIngresaTokenOTP() {
        theActorCalled("Kevin").attemptsTo(
                IngresarTokenOTP.ingresarToken()
        );
    }
