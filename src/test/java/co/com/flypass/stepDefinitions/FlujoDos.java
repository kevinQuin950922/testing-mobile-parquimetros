...
import co.com.flypass.utils.apiFlypass.CreateTransactionSinValor;
...
//        CreateTransactionSinValor createTransactionSinValor = new CreateTransactionSinValor();
//        createTransactionSinValor.createTransactionFromASFSinValor("ABC185","60","40800");
//    }
//
...
//        OnStage.theActorInTheSpotlight().should(seeThat(the(Notificaciones.NOTIFICACION),containsOnlyText("Flypasudo Acabas de estacionar en una Z.E.R")));
//    }
//
